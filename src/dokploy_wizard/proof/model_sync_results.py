...
PREFLIGHT_SCRIPT = zlib.decompress(base64.b85decode(_PREFLIGHT_ENCODED)).decode("utf-8").replace(
    '    templates = _coder_array_pages(base, "/api/v2/templates?limit=100&offset={offset}", headers)',
    '    templates = _request_json(base + "/api/v2/templates", headers)\n'
    '    if not isinstance(templates, list):\n'
    '        raise RuntimeError("invalid Coder templates")',
)

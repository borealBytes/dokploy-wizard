...
from dokploy_wizard.proof import BaselineAttestation, abort_guard_sha256, canonical_json_bytes
...
def derive_result_from_attestation(attestation: BaselineAttestation) -> dict[str, JsonValue]:
    ...
    return build_result({**attestation.result_body, "abort_guard_sha256": abort_guard_sha256(attestation)})
